...
<!--
- Future directions wishlist (dependent on funding/resources, and feedback)
  - Expand semantically queryable publication knowledgebase to 1000+ publications, with more non-open-access pubs contributed directly by authors 
  - Specialized NF agent (deep research, but for NF)
  - Including query access to People in the MCP server to help you network
-->
  

Leave empowered with practical skills to supercharge your research and accelerate scientific discoveries in NF!
