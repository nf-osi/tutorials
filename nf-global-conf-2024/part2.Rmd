...
<div class="notes">
- Make sure everyone has forked existing code
...
**Link to reproducible and interactive code in X**
...
- Learned simple steps of how to connect/load the data in this particular analysis environment
