...
- Noticed limitations for more custom computational analysis
...
It may take up to two weeks to get a confirmation in this case.

But let's say a couple of days later, you've gotten confirmation of access. You're ready to analyze, let's go to our notebook.
...
And yes, there is no one way to do things, but we hope we've showed you the essentials.
</div>
