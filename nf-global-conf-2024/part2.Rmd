...
Use Synapse's R client, `synapser`.
```{r}
...
- As a user, saw the couple of additional steps needed for connecting/loading the data into environment
- Learned basics of getting data from Synapse
- Learned basics of how to use this particular compute environment and its features
